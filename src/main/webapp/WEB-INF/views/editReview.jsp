...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <div class="container">
      <h1>Edit review for the product ${product.getName()}:</h1>
      <br>
      <br>
      ...
      <form:form modelAttribute="review" method="post">
        ...
        <div class="row">
          ...
          <div class="col">
            <input type="textarea" name="description" rows="8" cols="80" id="description" value="">
          </div>
        </div>
        ...
        <br>
          ...
          <div class="row">
            ...
            <div class="col">
              <input type="submit" name="Submit" value="Submit Edited Review">
            </div>
          </div>
